...
const totalEditField = [
  resumeDetailTitle,
  resumeDetailDate,
  resumeDetailContent,
];

const totalDetailElementField = [
  PluginName,
  resumeDetailTitleDateWrap,
  resumeDetailTitle,
  resumeDetailDate,
  resumeDetailContent,
];
          ...
          children: [
            {
              ...
              children: [
                {
                  type: resumeDetailTitle,
                  children: [{ text: '', leafType: resumeDetailTitle }],
                },
                {
                  type: resumeDetailDate,
                  children: [{ text: '', leafType: resumeDetailDate }],
                },
              ],
            },
            {
              type: resumeDetailContent,
...
export const ResumeDetailPluginFactory: PluginFactory = ({ editor }) => {
  return {
    ...
    match: (props) => {
      return totalDetailElementField.some(
        (name) => props.element.type === name,
      );
    },
